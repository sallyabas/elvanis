    ...
    <main style={{ minHeight: '100vh', background: '#F9FAFB', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Inter, sans-serif', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 560 }}>
        ...
        <div style={{ background: '#fff', borderRadius: 20, border: '1px solid #E5E7EB', padding: '36px 32px' }}>
          <div style={{ width: 52, height: 52, borderRadius: 12, background: '#FFF3E0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 26, marginBottom: 20 }}>
            📊
          </div>
          ...
          <p style={{ fontSize: 14, color: '#6B7280', marginBottom: 28, lineHeight: 1.6 }}>
            We found multiple Google Analytics properties. Select the one you want Elvanis to monitor.
          </p>
          ...
          {!loading && properties.length === 0 && !error && (
            <p style={{ color: '#6B7280', fontSize: 14 }}>
              No GA4 properties found under this account. Make sure you have Google Analytics 4 set up.
            </p>
          )}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 24 }}>
            {properties.map(p => (
              <button
                ...
                style={{
                  padding: '14px 18px',
                  border: `2px solid ${selected === p.property ? '#E37400' : '#E5E7EB'}`,
                  borderRadius: 12,
                  background: selected === p.property ? '#FFF3E0' : '#fff',
                  textAlign: 'left',
                  cursor: 'pointer',
          ...
          {selectedProperty && (
            <div style={{ background: '#FFF3E0', borderRadius: 10, padding: '12px 14px', marginBottom: 20 }}>
              <p style={{ fontSize: 13, color: '#92400E', margin: 0 }}>
                Elvanis will read traffic, conversion, and engagement data from <strong>{selectedProperty.displayName}</strong>
              </p>
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              background: !selected || saving ? '#E5E7EB' : '#E37400',
