...
<div style="max-width:600px;margin:0 auto;padding:32px 16px">
  ...
  <div style="text-align:center;margin-bottom:24px">
    <a href="${appUrl}/dashboard" style="display:inline-block;padding:12px 28px;background:#F9FAFB;color:#6B7280;border-radius:10px;font-size:14px;font-weight:600;text-decoration:none;border:1px solid #E5E7EB">View dashboard →</a>
  </div>
