  ...
  const PAGES = useMemo(() => [
    {
      ...
      questions: [
        { id: 'founder_stage',      section: t('assessment.section_context'),   label: t('assessment.q_founder_stage'),      why: t('assessment.why_founder_stage'),      type: 'choice' as const, options: OPTION_MAP.founder_stage },
        { id: 'business_model',     section: t('assessment.section_context'),   label: t('assessment.q_business_model'),     why: t('assessment.why_business_model'),     type: 'choice' as const, options: OPTION_MAP.business_model },
        { id: 'investment_status',  section: t('assessment.section_context'),   label: t('assessment.q_investment_status'),  why: t('assessment.why_investment_status'),  type: 'choice' as const, options: OPTION_MAP.investment_status },
        { id: 'team_size',          section: t('assessment.section_context'),   label: t('assessment.q_team_size'),          why: t('assessment.why_team_size'),          type: 'choice' as const, options: OPTION_MAP.team_size },
        { id: 'technical_capacity', section: t('assessment.section_context'),   label: t('assessment.q_technical_capacity'), why: t('assessment.why_technical_capacity'), type: 'choice' as const, options: OPTION_MAP.technical_capacity },
        { id: 'analytics_maturity', section: t('assessment.section_context'),   label: t('assessment.q_analytics_maturity'), why: t('assessment.why_analytics_maturity'), type: 'choice' as const, options: OPTION_MAP.analytics_maturity },
        { id: 'execution_blocker',  section: t('assessment.section_context'),   label: t('assessment.q_execution_blocker'),  why: t('assessment.why_execution_blocker'),  type: 'choice' as const, options: OPTION_MAP.execution_blocker },
      ],
    },
    {
      number: '02',
      ...
      questions: [
        { id: 'biggest_problem_now', section: t('assessment.section_context'),   label: t('assessment.q_biggest_problem_now'), why: t('assessment.why_biggest_problem_now'), type: 'text' as const },
        ...
        { id: 'already_tried',       section: t('assessment.section_context'),   label: t('assessment.q_already_tried'),       why: t('assessment.why_already_tried'),       type: 'text' as const },
        { id: 'target_90_days',      section: t('assessment.section_context'),   label: t('assessment.q_target_90_days'),      why: t('assessment.why_target_90_days'),      type: 'text' as const },
      ],
    },
    {
      number: '03',
